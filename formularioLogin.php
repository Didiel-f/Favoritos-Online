		...
		<div id="contenedor">
			<header>
				...
				<section id="login">
					...
					<div id="registrate"><a href="formularioCrearUsuario.php">Pulsa aquí para registrarte en la web</a></div>
				</section>
			</header>
			<section id="contenido">
				<section id="presentacion">
					<div id="atexto1"><h2>¿Cansado de perder tus favoritos?</h2></div>
					<div id="atexto2"><h2>¿Te gustaría no volver a perderlos?</h2></div>
				</section>
				<section id="etiquetas">
				<!--AQUÍ METERÉ EL CODIGO PHP-->

				<?php

					echo "<h2 align='center'>Algunos links que quizas te pueden interezar</h2>";

					$conexion = NEW PDO('sqlite:'.'favoritos.db');

					$consulta = $conexion->prepare("SELECT * FROM favoritos ORDER BY RANDOM() LIMIT 6");
					$consulta->execute();
	...
	<body>
		...
		<table border=1 width=100%>
			<tr>
				<td>
					<form action="login.php" method="post">
					<input type="text" name="usuario" value="Introduce aquí tu nombre" width=50%>
				</td>
			</tr>
			<tr>
				<td>
					<input type="text" name="contrasena" value="Introduce aquí tu contraseña" width=50%>
				</td>	
			</tr>
			<tr>
				<td>
		...
		¿No eres usuario todavía?. Pues pulsa <a href="formularioCrearUsuario.php">aquí para REGISTRARTE</a> 
	</body>
</html>
-->
